...
class com_wiris_util_xml_WCharacterBase {
	...
	static function isSupported($c) {
		$i = null;
		{
			$_g1 = 0; $_g = com_wiris_util_xml_WCharacterBase::$supportedUnicodeBySelectorList->length;
			while($_g1 < $_g) {
				$i1 = $_g1++;
				$unicode = com_wiris_util_xml_WCharacterBase::$supportedUnicodeBySelectorList[$i1];
				if($c === haxe_Utf8::charCodeAt($unicode, 0)) {
					return true;
				}
				unset($unicode,$i1);
			}
	...
	static $supportedUnicodeBySelectorList;
...
com_wiris_util_xml_WCharacterBase::$supportedUnicodeBySelectorList = com_wiris_util_xml_WCharacterBase::getUnicodesRangedStringList(com_wiris_util_xml_WCharacterBase::$UNICODES_SUPPORTED_BY_SELECTOR);
