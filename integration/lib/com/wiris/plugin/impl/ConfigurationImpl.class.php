...
class com_wiris_plugin_impl_ConfigurationImpl implements com_wiris_plugin_api_Configuration{
	...
	public function getJavaScriptHash() {
		...
		$javaScriptHash->set("versionMoodle", $this->getProperty("wirisversionmoodle", "unknown"));
		$javaScriptHash->set("categoryMoodle", $this->getProperty("wiriscategorymoodle", "unknown"));
		$javaScriptHash->set("courseMoodleId", $this->getProperty("wiriscoursemoodleid", "unknown"));
		$javaScriptHash->set("courseMoodleName", $this->getProperty("wiriscoursemoodlename", "unknown"));
