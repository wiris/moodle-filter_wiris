...
class filter_wiris_client extends moodle_text_filter {
    ...
    public function filter($text, array $options = array()) {
        ...
        $PAGE->requires->js(new moodle_url('/filter/wiris/render/WIRISplugins.js?viewer=image&safeXml=true&async=true&element=%23page&ignored_latex_containers=[data-fieldtype="editor"]'));
