...
$string['alloweditorpluginactive_help'] = 'WIRIS Editor plugin would be enabled regardless of WIRIS filter is disabled at course level. By default if WIRIS filter is disabled in a course, WIRIS Editor is also disabled in the same course.';
